  ...
  if (cast && cast.hash === warpcasthash && cast.reactions) {
    ...
    if (likes.some(like => like.fid === interactorFid) || recasts.some(recast => recast.fid === interactorFid)) {
      ...
      return c.res({
        ...
        intents: [
          <Button.Link href='https://warpcast.com/~/compose?text=A%20based%20product%20deserve%20a%20based%20launch!!!%0A%0AWe%27re%20crafting%20something%20extraordinary%20and%20want%20you%20to%20join%20the%20movement.%20Spread%20the%20word%20and%20be%20part%20of%20the%20revolution!&embeds[]=https://based-launch.vercel.app/api/start/'>Share</Button.Link>,
        ],
      });
    }
  }
